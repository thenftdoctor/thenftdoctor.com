...
function draw(){
  ...
  let leftTriangleFill = R.random_choice(colorList);
  let upperTriangleFill = R.random_choice(colorList);
  let rightTriangleFill = R.random_choice(colorList);
  let bottomTriangleFill = R.random_choice(colorList);
